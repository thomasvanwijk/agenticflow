...
export type ChromaCollection = Awaited<ReturnType<SemanticSearchCore["getCollection"]>>;

export async function getMemoryCollection(): Promise<ChromaCollection> {
    return semanticCore.getCollection("mcp_memory");
}
